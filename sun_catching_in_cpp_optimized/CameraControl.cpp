...
CameraControl::CameraControl(const std::string& camera_id)
...
bool CameraControl::capture_frame(double exposure_us, double gain, double offset, cv::Mat& output_image) {
